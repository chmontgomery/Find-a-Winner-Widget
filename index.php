...
$styles = "desktop_styles.php";
$viewport = "";
if ($isMobile) {
  $viewport = "<meta name='viewport' content='width=device-width' />";
  $styles = "mobile_styles.php";
}
?>
...
<body>
  <h1><?php if (!$isMobile) { ?><img id="top_img" src="question_dice.jpg" /><?php } ?>Who's the lucky winner?</h1>
  <div class="wrapper">
  ...
  <div class="wrapper">
    ...
    <div>Group name:</div>
    <div><input id="grp" type="text"/></div>
    <div>Names: (separate with spaces)</div>
    <div><textarea id="items"></textarea></div>
    <div><input type="button" value="Create Group" onclick="createGroup();" /></div>
  </div>
  <div class="wrapper">
    <h2>Find a Winner!</h2>
    <div id="savedGrps">
